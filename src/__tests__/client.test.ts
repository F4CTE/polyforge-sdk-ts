...
describe('Public user profile lookups', () => {
  ...
  it('getUserPerformance returns the bare array and forwards period as a query param', async () => {
    fetchSpy = vi.spyOn(globalThis, 'fetch').mockResolvedValue(
      new Response(
  ...
  it('getUserStrategies returns the bare array and forwards visibility/limit', async () => {
    fetchSpy = vi.spyOn(globalThis, 'fetch').mockResolvedValue(
      new Response(
        JSON.stringify([{
  ...
  it('getUserActivity returns the bare array and forwards limit', async () => {
    fetchSpy = vi.spyOn(globalThis, 'fetch').mockResolvedValue(
      new Response(
        JSON.stringify([{
  ...
  it('getUserBadgesByUsername returns the bare array', async () => {
    fetchSpy = vi.spyOn(globalThis, 'fetch').mockResolvedValue(
      new Response(
